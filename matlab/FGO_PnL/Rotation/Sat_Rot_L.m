...
function [lower_bound,theta_opt] = Sat_Rot_L(line_pair,Branch,epsilon,id,kernel_buffer,prox_thres)
N = line_pair.size;
...
if isempty(ids_lower)
    ...
    [lower_bound, theta_opt] = saturated_interval_stabbing(intervals_lower,ids_lower,kernel_buffer,prox_thres);
end
end
