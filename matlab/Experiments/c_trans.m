...
parfor num =1:length(valid_idx)
    ...
    num_candidate = size(t_best_candidates,2);
    [min_err,max_err,t_min]=min_max_trans_error(num_candidate,t_best_candidates,t_gt);
    Record_gt_SCM_power(num+1,:)={img_idx,M,epsilon_t,1-M/size(pert_rot_n_2D_inlier,1),0,max_err,min_err,num_candidate,best_score,score_t_gt_SCM_entropy,time};
    ...
    num_candidate = size(t_best_candidates,2);
    [min_err,max_err,t_min]=min_max_trans_error(num_candidate,t_best_candidates,t_gt);
    Record_gt_SCM_exp(num+1,:)={img_idx,M,epsilon_t,1-M/size(pert_rot_n_2D_inlier,1),0,max_err,min_err,num_candidate,best_score,score_t_gt_SCM_entropy,time};
    ...
    num_candidate = size(t_best_candidates,2);
    [min_err,max_err,t_min]=min_max_trans_error(num_candidate,t_best_candidates,t_gt);
    Record_gt_SCM_entropy(num+1,:)={img_idx,M,epsilon_t,1-M/size(pert_rot_n_2D_inlier,1),0,max_err,min_err,num_candidate,best_score,score_t_gt_SCM_entropy,time};
end
...
fprintf("CM_gt_FGO: %d \n",length(find(Record_gt_CM.("Max Trans Err")<0.1)))
fprintf("SCM_gt_FGO_power: %d \n",length(find(Record_gt_SCM_power.("Max Trans Err")<0.1)))
fprintf("SCM_gt_FGO_exp: %d \n",length(find(Record_gt_SCM_exp.("Max Trans Err")<0.1)))
fprintf("SCM_gt_FGO_entropy: %d \n",length(find(Record_gt_SCM_entropy.("Max Trans Err")<0.1)))
...
fprintf("CM_gt_FGO: %f,%f,%f\n",quantile(Record_gt_CM.("Max Trans Err"),[0.25,0.5,0.75]))
fprintf("SCM_gt_FGO_power: %f,%f,%f\n",quantile(Record_gt_SCM_power.("Max Trans Err"),[0.25,0.5,0.75]))
fprintf("SCM_gt_FGO_exp: %f,%f,%f\n",quantile(Record_gt_SCM_exp.("Max Trans Err"),[0.25,0.5,0.75]))
fprintf("SCM_gt_FGO_entropy: %f,%f,%f\n",quantile(Record_gt_SCM_entropy.("Max Trans Err"),[0.25,0.5,0.75]))
