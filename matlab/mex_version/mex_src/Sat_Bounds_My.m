function [Q_upper,Q_lower,theta_lower]=Sat_Bounds_My(line_pair,Branch,epsilon,sample_resolution,id)
...
[Q_lower, theta_lower] = saturated_interval_stabbing(intervals_lower,ids_lower);
[Q_upper, ~] = saturated_interval_stabbing(intervals_upper,ids_upper);
end
%%%%%%%%%%%%%%%%%%%%%%%%
