...
class FGO_PnL {
public:
  FGO_PnL(int max_iter, double rotation_epsilon, double branch_resolution,
          double sample_resolution, double translation_epsilon,
          double translation_resolution, string satured_kernel)
      : max_iter(max_iter), rotation_epsilon(rotation_epsilon),
  ...
  // data input
  void data_load(vector<Vector3d> &line_2ds, vector<Vector3d> &line_3ds,
  ...
  pair<double, double> satured_interval_stabbing(vector<double> &interval,
